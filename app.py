...
st.markdown(
    ...
    /* FIXED KEYBOARD_DOUBLE BUG: Explicitly targets ONLY the label text tags inside options, leaving icon spans untouched */
...
# High-Gloss SVG Profile Component (Solves the missing file image error permanently)
st.sidebar.markdown(
    """
    <div class="dev-profile-container">
        <div class="dev-avatar-wrapper">
            <svg width="46" height="46" viewBox="0 0 100 100" style="border-radius: 50%; border: 2px solid #7451F7; background:
