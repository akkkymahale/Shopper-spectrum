...
st.markdown(
    ...
    /* Explicitly targets ONLY the text inside radio buttons options */
...
# Uses your explicit Google Drive file ID parsed via direct web delivery CDN bypass link
st.sidebar.markdown(
    """
    <div class="dev-profile-container">
        <div class="dev-avatar-wrapper">
            <img src="https://lh3.googleusercontent.com/d/1wGYtf22gb7TGrSl2tJRJFnulwCVSRk3o" width="46" height="46" style="border-radius: 50%; object-fit: cover; border: 2px solid #7451F7; background: #1F1936;" alt="Developer Profile">
